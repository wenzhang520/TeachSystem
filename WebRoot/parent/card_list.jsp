	...
	<body>
		...
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<%
				...
				String fysql = "select count(id) as ss from card where stu='"+childname+"'";
				...
				sql = "select top " + page_record
						+ " * from card where stu='"+childname+"'"+"and id not in (select top "
		...
		<p align="center">
			...
			<a href="card_list.jsp?page=1">首页</a>
			<a href="card_list.jsp?page=<%=curpage - 1%>">上一页</a>
			<A href="card_list.jsp?page=<%=curpage + 1%>">下一页</A>
			<a href="card_list.jsp?page=<%=zys%>">尾页</A> 当前第
