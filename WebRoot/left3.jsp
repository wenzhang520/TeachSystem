									...
									<TABLE id=submenu1 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="parent/parent_updt.jsp" target=main>个人信息管理</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<TABLE id=submenu4 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="parent/notice_list.jsp" target=main>公告信息查看</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<TABLE id=submenu5 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="parent/record_list.jsp" target=main>课堂表现信息查看</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<TABLE id=submenu6 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											...
											<TR>
												...
												<TD height=23>
													<A href="parent/score_list.jsp" target=main>学生成绩查看</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<TABLE id=submenu7 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="parent/card_list.jsp" target=main>一卡通消费信息查看</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<TABLE id=submenu8 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="parent/library_list.jsp" target=main>图书馆借阅信息查看</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
									...
									<TABLE id=submenu8 cellSpacing=0 cellPadding=0 width="100%"
										...
										<TBODY>
											<TR>
												...
												<TD height=23>
													<A href="parent/message_add.jsp" target=main>新增留言</A>
												</TD>
											</TR>
											...
											<TR>
												...
												<TD height=23>
													<A href="parent/message_list.jsp" target=main>留言管理</A>
												</TD>
											</TR>
										</TBODY>
									</TABLE>
