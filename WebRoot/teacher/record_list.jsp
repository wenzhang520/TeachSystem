	...
	<body>
		...
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<%
				...
				String fysql = "select count(id) as ss from record";
				...
				sql = "select top " + page_record
						+ " * from record where id not in (select top "
			...
			<tr>
				...
				<td width="90" align="center">
					<a href="teacher/record_updt.jsp?id=<%=id%>">修改</a>
					<a href="del.jsp?id=<%=id%>&tablename=record"
