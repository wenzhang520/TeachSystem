	...
	<body>
		...
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<%
				...
				String fysql = "select count(id) as ss from score";
				...
				sql = "select top " + page_record
						+ " * from score where id not in (select top "
			...
			<tr>
				...
				<td width="90" align="center">
					<a href="teacher/score_updt.jsp?id=<%=id%>">修改</a>
					<a href="del.jsp?id=<%=id%>&tablename=score"
		...
		<p align="center">
			...
			<a href="score_list.jsp?page=1">首页</a>
			<a href="score_list.jsp?page=<%=curpage - 1%>">上一页</a>
			<A href="score_list.jsp?page=<%=curpage + 1%>">下一页</A>
			<a href="score_list.jsp?page=<%=zys%>">尾页</A> 当前第
