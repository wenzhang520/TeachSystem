	...
	<body>
		...
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<%
				...
				String fysql = "select count(id) as ss from message";
				...
				while (RS_result.next()) {
					...
					parentname = RS_result.getString("parentname");
			...
			<tr>
				...
				<td width="90" align="center">
					<%
						...
						%>
						<a href="teacher/message_reply.jsp?id=<%=id%>&parentname=<%=parentname %>&msg=<%=msg %>">回复</a>
						<%
						}
					 %>
